...
from enemy_spawner import EnemySpawner  # Import the spawner
...
class Level:
    def __init__(self):
        ...
        # Initialize enemy spawn points list
        self.enemy_spawn_points = []

        # create the map and record enemy spawn points
        self.create_map()
        ...
        # Instantiate the enemy spawner with area-based, time-based respawn
                    ...
                    if style == 'boundary':
                        ...
                        if col == '394':  # Player spawn
                            ...
                            if col == '390':
                                ...
                                monster_name = 'squid'
                            # Create enemy for initial placement
                            Enemy(
                                monster_name,
                                (x, y),
                                ...
                                self.add_exp)
                            # Record spawn point for area-based respawning
