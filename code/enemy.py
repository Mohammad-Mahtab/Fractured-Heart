...
# Global cache for enemy sounds and animations
sound_cache = {}
animation_cache = {}
...
class Enemy(Entity):
    def __init__(self, monster_name, pos, groups, obstacle_sprites, damage_player, trigger_death_particles, add_exp):
        ...
        self.update_interval = randint(3, 5)
        self.last_update = 0
    ...
    def import_graphics(self, name):
        ...
        # Optionally, cache animations if desired
        # animation_cache[name] = self.animations
